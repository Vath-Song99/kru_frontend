...
const VerifyLogin = () => {
  ...
  return (
    <>
      ...
      {isPopupOpen && (
        <div className="fixed inset-0 flex flex-col w-[350px] h-[400px] sm:w-[470px] sm:h-[470px] md:w-[470px] md:h-[470px] lg:w-[470px] lg:h-[470px] xl:w-[470px] xl:-[470px] mx-auto p-5 gap-5 bg-white rounded-md border shadow-lg items-center">
