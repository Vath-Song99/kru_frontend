                ...
                <div className="flex flex-col w-[80%]">
                  ...
                  <div className="flex flex-col gap-2 mt-3">
                    ...
                    <div className="bg-[#F0F7FF] flex w-full h-[70px] justify-between items-center px-4 rounded-lg">
                      ...
                      <div className="relative w-[40px] h-[40px]  sm:w-[60px] sm:h-[60px] md:w-[60px] md:h-[60px] lg:w-[50px] lg:h-[50px] xl:w-[60px] xl:h-[60px]  sm:w-[60px] sm:h-[60px] md:w-[60px] md:h-[60px] lg:w-[50px] lg:h-[50px] xl:w-[60px] xl:h-[60px]">
                        <svg className="w-full h-full" viewBox="0 0 100 100">
                          {/* Background circle  */}
                          <circle
                            className="text-gray-200 stroke-current"
